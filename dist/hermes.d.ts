...
declare class Hermes {
  ...
  static obj2str<T extends Hermes.NestedObject | Array<unknown>>(obj: T, infNaN?: boolean): string;
  static str2obj<T extends Hermes.NestedObject | Array<unknown>>(str: string, infNaN?: boolean): T;
