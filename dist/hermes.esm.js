...
class Hermes {
    ...
    calculate() {
        ...
        this.dimensions.forEach((dimension, index) => {
            ...
            if (_dlil.lengthCos > _dsl.cosMax)
                _dsl.cosMax = _dlil.lengthCos;
            if (_dlil.lengthSin > _dsl.sinMax)
                _dsl.sinMax = _dlil.lengthSin;
        });
        /**
    ...
    drawDimensions() {
        ...
        style.placement;
        normalizePadding(this.options.style.padding);
        this.ctx.save();
