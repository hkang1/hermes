...
class Hermes {
  ...
  static obj2str<T extends t.NestedObject>(obj: T, infNaN?: boolean): string {
    return d.obj2str(obj, infNaN);
  }

  static str2obj<T extends t.NestedObject>(str: string, infNaN?: boolean): T {
    return d.str2obj(str, infNaN);
  }
