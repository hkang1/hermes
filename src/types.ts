...
export type HasNullAndUndefined<T> = null | undefined | T;
...
export interface InternalDimensionLayoutInfo {
  hasInfinity: boolean;
  hasNaN: boolean;
...
export type DataRaw = Record<DimensionKey, HasNullAndUndefined<Primitive>[]>;
