# Hermes Parallel Coordinates [![CircleCI](https://circleci.com/gh/hkang1/hermes.svg?style=shield)](https://app.circleci.com/pipelines/github/hkang1/hermes?branch=main) [![codecov](https://codecov.io/gh/hkang1/hermes/branch/main/graph/badge.svg?token=JNS0KB6VXX)](https://codecov.io/gh/hkang1/hermes)
...
Check out the list of [Demos](https://deploy-preview-146--bejewelled-lamington-f97ebd.netlify.app/) to get an idea of the various capabilities and config options.
