import { GLASBEY } from '@/constants/glasbey';
...
export const isMonochrome = (rgba: RgbaColor, tolerance = 0): boolean => {
  return (
    Math.abs(rgba.r - rgba.g) < tolerance &&
    Math.abs(rgba.g - rgba.b) < tolerance
  );
};
...
export const rgbDistance = (rgba0: RgbaColor, rgba1: RgbaColor): number => {
  return pointDistance(
    [ rgba0.r, rgba0.g, rgba0.b ],
    [ rgba1.r, rgba1.g, rgba1.b ],
  );
};
